    ...
    <>
      ...
      <section className="text-container">
        ...
        <p>
          ...
          s'appliquent, sans restriction ni réserve à tout achat des services de
          suivants :
        </p>
        <p>
          Petites annonces en ligne, et usage de notre monnaie virtuelle tels
          que proposés par le Prestataire aux clients non professionnels (« Les
          Clients ou le Client ») sur le site.
        </p>
        <p>
          Les caractéristiques principales des Services sont présentées sur le
          site internet <strong>krysto.nc</strong>. Le Client est tenu d'en
          prendre connaissance avant toute passation de commande. Le choix et
          l'achat d'un Service est de la seule responsabilité du Client.
        </p>
        <p>
          Ces CGV sont accessibles à tout moment sur le site{' '}
          <strong>krysto.nc</strong> et prévaudront sur toute autre document. Le
          Client déclare avoir pris connaissance des présentes CGV et les avoir
          acceptées en cochant la case prévue à cet effet avant la mise en œuvre
          de la procédure de commande en ligne du site{' '}
          <strong>krysto.nc</strong>. Sauf preuve contraire, les données
          enregistrées dans le système informatique du Prestataire constituent
        ...
        <p>
          ...
          <strong>krysto.nc</strong>, lors de l'enregistrement de la commande
          par le Prestataire. Les prix sont exprimés en Francs Pacifique, TTC.
        </p>
        <p>
          Les tarifs tiennent compte d'éventuelles réductions qui seraient
          consenties par le Prestataire sur le site <strong>krysto.nc</strong>.
          ...
          validité, d’en modifier les prix à tout moment. Le paiement demandé au
          Client correspond au montant total de l'achat. Une facture est établie
          par le Prestataire et remise au Client lors de la fourniture des
          Services commandés.
        </p>
        <h4>ARTICLE 3 – Commandes</h4>
        <p>
          Il appartient au Client de sélectionner sur le site{' '}
          <strong>krysto.nc</strong> les Services qu'il désire commander, selon
          les modalités suivantes :
        </p>
        <ul>
          <li>
            - Au moment de son inscription, le Client choisie l'abonnement de
            son choix.
          </li>
          <li>
            - Il doit ensuite valider son adresse e-mail, avant de réaliser le
            paiement de son abonnement.
          </li>
          <li>
            - Lorsque son e-mail est validé, il lui est demandé de réaliser le
            paiement de son abonnement.
          </li>
        </ul>
        <p>
          ...
          et de signaler immédiatement toute erreur. Toute commande passée sur
          le site <strong>krysto.nc</strong> constitue la formation d'un contrat
        ...
        <p>
          ...
          paiement d'une commande antérieure. Le Client pourra suivre
          l'évolution de sa commande sur le site. La passation d'une commande
          sur le site <strong>krysto.nc</strong> implique la conclusion d'un
          contrat d'une durée minimum de 1 mois renouvelable pour une même durée
          par tacite reconduction.
        </p>
        <p>
          Aux termes de l'article L 215 -1 du Code de la consommation, reproduit
          ci-dessous :
        </p>
        <p>
          <i>
            "Pour les contrats de prestations de services conclus pour une durée
            déterminée avec une clause de reconduction tacite, le professionnel
            prestataire de services informe le consommateur par écrit, par
            lettre nominative ou courrier électronique dédiés, au plus tôt trois
            mois et au plus tard un mois avant le terme de la période autorisant
            le rejet de la reconduction, de la possibilité de ne pas reconduire
            le contrat qu'il a conclu avec une clause de reconduction tacite.{' '}
          </i>
        </p>
        <p>
          <i>
            Cette information, délivrée dans des termes clairs et
            compréhensibles, mentionne, dans un encadré apparent, la date limite
            de non- reconduction. Lorsque cette information ne lui a pas été
            adressée conformément aux dispositions du premier alinéa, le
            consommateur peut mettre gratuitement un terme au contrat, à tout
        ...
        <p>
          <i>
            ...
            cas remboursées dans un délai de trente jours à compter de la date
            de résiliation, déduction faite des sommes correspondant, jusqu'à
            celle-ci, à l'exécution du contrat. Les dispositions du présent
            article s'appliquent sans préjudice de celles qui soumettent
            légalement certains contrats à des règles particulières en ce qui
        ...
        <p>
          ...
          pasation de la commande. Les données de paiement sont échangées en
          mode crypté grâce au protocole défini par le prestataire de paiement
          agréé intervenant pour les transactions bancaires réalisées sur le
          site <strong>krysto.nc</strong>.
        </p>
        <p>
        ...
        <h4>ARTICLE 5 - Fourniture des Prestations</h4>
        <p>
          Les Services commandés par le Client seront fournis selon les
          modalités suivantes :
        </p>
        <ul>
          <li>- Service de petites annonces en ligne, et monnaie virtuelle.</li>
        </ul>
        <p>
          Les dits Services seront fournis dans un délai maximum de 24h à
          compter de la validation définitive de la commande du Client, dans les
          conditions prévues aux présentes CGV sur le site{' '}
          <strong>krysto.nc</strong>.
        </p>
        <p>
          Le Prestataire s'engage à faire ses meilleurs efforts pour fournir les
          Services commandés par le Client, dans le cadre d'une obligation de
          moyen et dans les délais ci-dessus précisés. Si les Services commandés
          n'ont pas été fournis dans un délai de 7 jours après la date
          indicative de fourniture, pour toute autre cause que la force majeure
          ou le fait du Client, la vente des Services pourra être résolue à la
          demande écrite du Client dans les conditions prévues aux articles L
          216-2, L 216-3 et L241-4 du Code de la consommation.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          lors de la réception des Services, ceux-ci seront réputés conformes à
          la commande, en quantité et qualité. Le Client disposera d'un délai de
          24h à compter de la fourniture des Services pour émettre des
          réclamations par e-mail, avec tous les justificatifs y afférents,
          auprès du Prestataire.
        </p>
        <p>
          Aucune réclamation ne pourra être valablement acceptée en cas de non
          respect de ces formalités et délais par le Client
        </p>
        <p>
          Le Prestataire remboursera ou rectifiera dans les plus brefs délais et
          à ses frais les Services dont le défaut de conformité aura été dûment
        ...
        <p>
          ...
          Prestataire aux coordonnées postales ou mail indiquées à l’ARTICLE 1
          des présentes CGV.{' '}
        </p>
        <p>
          En cas d'exercice du droit de rétractation dans le délai susvisé, seul
          le prix des Services commandés est remboursé.
        </p>
        <p>
          Le remboursement des sommes effectivement réglées par le Client sera
          effectué dans un délai de 14 jours à compter de la réception, par le
          Prestataire, de la notification de la rétractation du Client.
        </p>
        <h4>ARTICLE 7 - Responsabilité du Prestataire - Garanties</h4>
        <p>
          Le Prestataire garantit, conformément aux dispositions légales et sans
          paiement complémentaire, le Client, contre tout défaut de conformité
          ou vice caché, provenant d'un défaut de conception ou de réalisation
          des Services commandés dans les conditions et selon les modalités
          suivantes : Dispositions relatives aux garanties légales Article
        ...
        <p>
          <i>« Le bien est conforme au contrat :</i>
        </p>
        <p>
          <i>
        ...
        <p>
          ...
          Prestataire, par écrit (mail ou courrier), de l'existence des vices ou
          défauts de conformité. Le Prestataire remboursera ou rectifiera ou
          fera rectifier (dans la mesure du possible) les services jugés
          défectueux dans les meilleurs délais et au plus tard dans les 30 jours
          suivant la constatation par le Prestataire du défaut ou du vice. Ce
          remboursement pourra être fait par virement ou chèque bancaire.
        </p>
        <p>
        ...
        <p>
          ...
          défaillant pour tout retard ou inexécution consécutif à la survenance
          d'un cas de force majeure habituellement reconnu par la jurisprudence
          française.
        </p>
        <p>
          Les Services fournis par l'intermédiaire du site du Prestataire sont
          conformes à la réglementation en vigueur en France. La responsabilité
          du Prestataire ne saurait être engagée en cas de non respect de la
        ...
        <h4>ARTICLE 8 - Données personnelle</h4>
        <p>
        ...
        <h5>8.1 Collecte des données à caractère personnel :</h5>
        <p>
          Les données à caractère personnel qui sont collectées sur le site{' '}
          <strong>krysto.nc</strong> sont les suivantes : Ouverture de compte
          Lors de la création du compte Client / utilisateur : adresse e-mail.
        </p>
        <h5>8.2 Destinataires des données à caractère personnel :</h5>
        <p>
          ...
          données est le Prestataire, au sens de la loi Informatique et libertés
          et à compter du 25 mai 2018 du Règlement 2016/679 sur la protection
          des données à caractère personnel.
        </p>
        <h5>8.4 Limitation du traitement :</h5>
        <p>
        ...
        <h5>8.5 Durée de conservation des données :</h5>
        <p>
        ...
        <h5>8.6 Sécurité et confidentialité :</h5>
        <p>
          ...
          signaler qu’Internet n’est pas un environnement complètement sécurisé
          et le Prestataire ne peut garantir la sécurité de la transmission ou
          du stockage des informations sur Internet.
        </p>
        <h5>8.7 Mise en œuvre des droits des Clients et utilisateurs :</h5>
        <p>
          En application de la règlementation applicable aux données à caractère
          personnel, les Clients et utilisateurs du site{' '}
          <strong>krysto.nc</strong> disposent des droits suivants :
        </p>
        <ul>
          <li>
            - Ils peuvent mettre à jour ou supprimer les données qui les
            concernent de la manière suivante : en se connectant à son compte,
          ...
          <li>
            ...
            l’article 9.3 <i>« Responsable de traitement »</i>{' '}
          </li>
          <li>
            {' '}
            - Enfin, ils peuvent s’opposer au traitement de leurs données par le
            Prestataire Ces droits, dès lors qu’ils ne s’opposent pas à la
            finalité du traitement, peuvent être exercé en adressant une demande
            par courrier ou par E-mail au Responsable de traitement dont les
        ...
        <p>
          ...
          Client, celui-ci doit être motivé
        </p>
        <p>
        ...
        <p>
          ...
          de la part du Prestataire. Il aura toujours la possibilité de retirer
          son accord à tout moment en contactant le Prestataire (coordonnées
          ci-dessus) ou en suivant le lien de désabonnement.
        </p>
        <h4>ARTICLE 9 - Propriété intellectuelle</h4>
        <p>
          Le contenu du site otomony.fr est la propriété du Vendeur et de ses
          partenaires et est protégé par les lois françaises et internationales
          relatives à la propriété intellectuelle. Toute reproduction totale ou
        ...
        <p>
          ...
          soumises au droit français. Les présentes CGV sont rédigées en langue
          française. Dans le cas où elles seraient traduites en une ou plusieurs
          langues étrangères, seul le texte français ferait foi en cas de
          litige.
        </p>
        ...
        <p>
          IMédiation NC <br />{' '}
          <a href="http://www.imediation.nc/">
            {' '}
            <strong>Site internet:</strong> http://www.imediation.nc/
          </a>{' '}
          <br /> <strong>E-mail: </strong> contact@imediation.nc
        </p>
        <p>
